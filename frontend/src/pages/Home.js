const HomePage = (props) => {
    return (
        ...
        <div className="nosotros">
            ...
            <img src="imagenes/astronauta1.jpg" alt=""/>
            ...
            <p>3... 2... 1...</p>
            <h3>¡DESPEGUE!</h3>
            <img src="https://1.bp.blogspot.com/-7Uyb9wwv1hY/YD_bcg5SgyI/AAAAAAAAGCg/q5Kq6EUwgS4_v0itxagibduKUBi6Z6SRQCLcBGAsYHQ/s400/27.gif" alt=""/>
        </div>
        <br/>
        <div className="uno">
